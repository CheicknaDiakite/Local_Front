...
interface RowData {
  ...
  name: string;
  fat: number;
  carbs: number; // This seems to represent order status
  protein: number; // Total Amount
}

function createData(tracking_no: number, name: string, fat: number, carbs: number, protein: number): RowData {
...
const OrderTableHead: FC<OrderTableHeadProps> = ({ order, orderBy }) => (
  <TableHead>
    <TableRow>
