...
export default function SalesChart() {
  ...
  const [series, setSeries] = useState<typeof initialSeries>(initialSeries);
  ...
  const [options, setOptions] = useState<ApexCharts.ApexOptions>(columnChartOptions);
